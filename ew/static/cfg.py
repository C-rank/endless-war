...
# What style of capping to use - "active" is season 3, "idle" is season 2
capping_style = "idle"
...
# Whether or not the double halloween event is active or not
dh_active = False

# Whether or not the slimernalia event is active or not
